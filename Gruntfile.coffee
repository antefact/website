module.exports = (grunt) ->
    grunt.initConfig
        ...
        less:
            dev:
                paths: ['site/themes/antefact/static/less']
                src: ['site/themes/antefact/static/less/styles.less']
        ...
        svg_sprite        : {
            dist          : {
                expand    : true,
                cwd       : 'site/themes/antefact/static/svg/',
                src       : '**/*.svg',
                dest      : 'site/themes/antefact/static/',
                options   : "mode": {
                  "symbol": true,
                  "log": "verbose",
                  "inline": true,
        ...
        watch:
            options:
                ...
                livereload: true
            less:
                files: ['site/themes/antefact/static/less/*.less']
                tasks: 'less:dev'
            coffee:
                files: ['coffee/*.coffee']
